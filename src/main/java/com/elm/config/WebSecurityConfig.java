...
import com.elm.web.Filter.JwtAuthenticationFilter;
import com.elm.web.Manager.SttAuthorizationManager;
import com.elm.web.MyUserDetailsService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity.authorizeHttpRequests(
                authorizeHttpRequests->authorizeHttpRequests
                        .requestMatchers("/user/getUserExistByPhone","/user/saveUser","/user/login","/doc.html", "/swagger-ui.html", "/webjars/**", "/v3/api-docs/*", "/swagger-resources/**","/favicon.ico").permitAll() //knife4j页面资源
                        //使用自定义认证逻辑
